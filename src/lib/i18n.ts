...
export const translations = {
  ...
  hu: {
    ...
    chart: {
      ...
      value: "Érték",
      rawRank: "Rang",
      logRank: "Rang, log skála",
      logValue: "log skála",
      tailThreshold: "küszöb, log skála",
      tailProbability: "Legalább ekkora valószínűség, log skála",
      atLeast: "Legalább",
    },
    scaleModes: {
      linear: {
  ...
  ro: {
    ...
    chart: {
      ...
      value: "Valoare",
      rawRank: "Rang",
      logRank: "Rang, scală log",
      logValue: "scală log",
      tailThreshold: "prag, scală log",
      tailProbability: "Probabilitate cel puțin atât de mare, scală log",
      atLeast: "Cel puțin",
    },
    scaleModes: {
      linear: {
